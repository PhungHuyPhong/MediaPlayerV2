    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    if (playlistModel) {
                        playlistModel.addItem("New Track;New Artist;180");
                    }
                }
            ...
            Button {
                ...
                onClicked: {
                    if (playlistModel && playlistView.currentIndex >= 0) {
                        playlistModel.removeItem(playlistView.currentIndex);
                    }
                }
        ...
        ListView {
            ...
            Binding {
                ...
                value: playlistModel ? playlistModel.currentIndex : -1
            }

            delegate: Rectangle {
                width: playlistView.width
                height: 50
                color: index === playlistModel.currentIndex ? "#55aaff" :
        ...
        Label {
            ...
            Layout.fillWidth: true
            visible: playlistModel ? playlistModel.count === 0 : true
        }
    }
}
