...
Rectangle {
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            Rectangle {
                id: progressFill
                width: parent.width * (mediaPlayer ? mediaPlayer.position / Math.max(1, mediaPlayer.duration) : 0)
            ...
            Rectangle {
                ...
                radius: 10
                color: "#99ccff"
                x: parent.width * (mediaPlayer ? mediaPlayer.position / Math.max(1, mediaPlayer.duration) : 0) - width / 2
                y: 0
