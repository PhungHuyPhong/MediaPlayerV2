...
Rectangle {
    ...
    Rectangle {
        ...
        anchors.margins: -4
        color: "transparent"
        border.width: mediaPlayer && mediaPlayer.playing ? 2 : 0
        border.color: activeColor
        opacity: 0.7
        radius: 8
        visible: mediaPlayer && mediaPlayer.playing

        SequentialAnimation on border.color {
            running: mediaPlayer && mediaPlayer.playing
    ...
    RowLayout {
        ...
        Button {
            id: playPauseButton
            icon.name: mediaPlayer && mediaPlayer.playing ? "media-playback-pause" : "media-playback-start"
            icon.width: 32
            icon.height: 32
            ...
            ToolTip.text: mediaPlayer && mediaPlayer.playing ? "Pause playback" : "Start playback"
            ToolTip.visible: hovered
            ToolTip.delay: 500
        }
        ...
        Button {
            ...
            enabled: mediaPlayer ? mediaPlayer.canGoNext : false
